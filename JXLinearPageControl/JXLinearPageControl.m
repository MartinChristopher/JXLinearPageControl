//
//  JXLinearPageControl.m
//
//  Created by Apple on 2021/7/2.
//

#import "JXLinearPageControl.h"

@interface JXLinearPageControl ()
...
@implementation JXLinearPageControl
...
- (void)setNumberOfPages:(NSInteger)numberOfPages {
    ...
    for (int i = 0; i < numberOfPages; i++) {
        ...
        dotView.layer.cornerRadius = self.dotCornerRadius;
